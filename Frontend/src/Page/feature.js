    ...
    render(){
        return(
            <div id="page-wrapper">
                ...
                <div className="row">
                    <Card title="1. Products Crawler from Three Different Sites" >
                    ...
                    <div>&nbsp;&nbsp;</div>
                    <Card title="2. Products Search Engine" >
                        <div className="col-md-12">
                    ...
                    <div>&nbsp;&nbsp;</div>
                    <Card title="3. Recommendation and Finding Similar Products" >
                        <div className="col-md-12">
                    ...
                    <div>&nbsp;&nbsp;</div>
                    <Card title="4. Neo4J Graph Visualization" >
                        <div className="col-md-12">
